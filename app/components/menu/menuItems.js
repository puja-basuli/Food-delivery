...
export default function MenuItemCard() {
  return (
   <div className="bg-blue-100 p-4 sm:p-6 rounded-lg text-center shadow-md hover:bg-amber-100 hover:shadow-lg transition-shadow transition-transform duration-200 hover:scale-105">
